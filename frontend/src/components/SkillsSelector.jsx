                    ...
                    <div className="flex flex-wrap gap-2">
                        {currentSelected.map((skill) => (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-xs font-medium border bg-[#0c2340] border-[#0c2340] text-white shadow-sm active:scale-[0.98]"
                            >
                                <span>{skill}</span>
