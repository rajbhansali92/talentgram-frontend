...
HELP_TEXT = (
    ...
    "2. SHARE\n"
    "━━━━━━━━━━━━━━━━━━\n\n"
    "WHAT IT DOES: sends a saved template (like the casting call) or a "
    "custom message to one or more talents, or to everyone currently in "
    "a pipeline stage — for one project or several at once.\n\n"
    ...
    "Examples:\n\n"
    "One project, one talent:\n"
    "Share the casting call for Hinge with Anusha Sharma\n\n"
    "Multiple projects, multiple talents:\n"
    "Share the casting call for Hinge, L'Oreal with Anusha Sharma, Riya Sharma\n\n"
    "Project + pipeline stage:\n"
    "Share the casting call for Hinge to shortlisted\n"
    "Share the casting call for shortlisted in Hinge\n\n"
    "Custom quoted message + talent:\n"
    "Share \"Hi! You've been shortlisted for Dulux.\" with Anusha Sharma\n\n"
    "Custom quoted message + pipeline stage:\n"
    "Share \"Hi! You've been shortlisted for Dulux.\" to shortlisted in Hinge\n\n"
    "Anusha Sharma's Instagram profile:\n"
    ...
    "message is sent exactly as written — commas, line breaks, "
    ...
    "• Before sending, I check that every talent is actually in each "
    "named project's pipeline. If someone's missing, I show exactly "
    "which pairs and offer: 1) add them and move to Follow Up, then "
    "share, 2) share only where they're already in the pipeline, or "
    "3) cancel.\n"
    "• Nothing is ever sent until you reply 1 to Approve on the final "
    "preview. Reply 2 to Edit — I'll ask which part (Projects, "
    "Recipients, or Message/Template) using its own numbered menu, "
    "never mixed up with Approve/Edit/Cancel.\n\n"
    "━━━━━━━━━━━━━━━━━━\n"
    "3. SEND\n"
    "━━━━━━━━━━━━━━━━━━\n\n"
