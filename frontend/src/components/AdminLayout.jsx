...
const LoadingFallback = () => (
  <div className="w-full max-w-4xl mx-auto p-6 space-y-6">
    <div className="flex items-center space-x-4">
      <div className="w-12 h-12 rounded-full animate-tg-shimmer" />
      <div className="space-y-2 flex-1">
        <div className="h-4 w-1/4 rounded animate-tg-shimmer" />
        <div className="h-3 w-1/3 rounded animate-tg-shimmer" />
      </div>
    </div>
    <div className="space-y-3">
      <div className="h-4 w-full rounded animate-tg-shimmer" />
      <div className="h-4 w-5/6 rounded animate-tg-shimmer" />
      <div className="h-4 w-2/3 rounded animate-tg-shimmer" />
    </div>
  </div>
);
