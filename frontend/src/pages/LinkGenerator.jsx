                ...
                >
                    {MODES.map((m) => (
                        <button
                            ...
                            className="group text-left bg-white border border-black/[0.08] hover:border-black/[0.16] rounded-xl p-6 transition-colors duration-150"
                        >
                            <div className="flex items-center justify-between mb-4">
                                <m.icon
                                    ...
                                    strokeWidth={1.4}
                                />
                                <span className="text-[10px] text-black/40 tracking-widest font-mono">
                                    {m.tag}
                                </span>
                            </div>
                            <h3 className="font-display text-lg text-black/85 mb-2">
                                {m.title}
                            </h3>
    ...
    return (
        ...
        >
            ...
            <div className="mb-8 flex items-end justify-between flex-wrap gap-4">
                <div>
                    <p
                        className="eyebrow mb-3 text-black/45"
                ...
                {!isEdit && (
                    <button
                        ...
                        className="text-xs text-black/60 hover:text-black/80 inline-flex items-center gap-1 underline-offset-4 hover:underline transition-colors duration-150"
                    >
                        Change link type
                    </button>
                )}
            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <section className="bg-white border border-black/[0.08] rounded-xl p-6">
                        ...
                        <label className="flex items-center gap-3 mt-4">
                            <input
                                ...
                                className="w-4 h-4 rounded border-black/[0.2] accent-black"
                            />
                    ...
                    <section className="bg-white border border-black/[0.08] rounded-xl p-6">
                            ...
                            {VIS_ITEMS.map((v) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className={`w-9 h-5 rounded-full relative transition-colors duration-150 ${visibility[v.key] ? "bg-black" : "bg-black/15"}`}
                                    >
                                        <span
                                            className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full transition-transform duration-150 ${visibility[v.key] ? "translate-x-4 bg-white" : "bg-white"}`}
                                        />
                                    </button>
                                </label>
                            ))}
                        ...
                        {mode === "individual" && (
                            <p className="text-[10px] text-black/45 mt-4 leading-relaxed">
                    ...
                    <section className="bg-white border border-black/[0.08] rounded-xl p-6">
                        ...
                        <textarea
                            ...
                            className="w-full bg-[#fafaf8] border border-black/[0.08] focus:border-black/[0.16] rounded-lg p-3 text-sm text-black/85 placeholder:text-black/30 outline-none transition-colors duration-150"
                        />
                    </section>
                ...
                <div className="lg:col-span-2 bg-white border border-black/[0.08] rounded-xl p-6 min-h-[480px]">
                    <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
                        <div>
                            ...
                            <p
                                className="text-xs text-black/45 mt-1"
                    ...
                    {mode === "individual" && (
                        filteredTalents.length === 0 ? (
                            <div className="text-black/45 text-sm py-10 text-center">
                                No talents found.{" "}
                                <Link
                                    to="/admin/talents/new"
                                    className="underline hover:text-black/80 transition-colors duration-150"
                                >
                                    Add talents first
                                </Link>
                                .
                    ...
                    {mode === "showcase" && (
                        <div className="space-y-4">
                            ...
                            {projects.length === 0 ? (
                                <div className="text-black/45 text-sm py-8 text-center bg-white border border-black/[0.08] rounded-lg">
                                    No projects yet.{" "}
                                    <Link
                                    ...
                                    {projects.map((p) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`text-left bg-white border rounded-lg p-4 transition-colors duration-150 ${active ? "border-black/40 bg-black/[0.02]" : "border-black/[0.08] hover:border-black/[0.16]"}`}
                                            >
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="min-w-0">
                                                        <div className="font-display text-sm text-black/85 truncate">
                                                            {p.brand_name ||
                                                                "Untitled Project"}
                                                        </div>
                                                        <div className="text-[11px] text-black/45 mt-1 truncate">
                                                            {p.character ||
                                                                "—"}
                                                        </div>
                                                    </div>
                                                    {active && (
                                                        <div className="w-6 h-6 bg-black text-white flex items-center justify-center rounded-md shrink-0">
                                                            <Check className="w-3.5 h-3.5" />
                                                        </div>
                                                    )}
                                                </div>
                                                <div className="text-[10px] text-black/45 mt-3 inline-flex items-center gap-1.5">
...
function PerTalentVisibilityModal({
    ...
    return (
        ...
        >
            <div
                className="bg-white border border-black/[0.08] rounded-xl max-w-lg w-full max-h-[85vh] overflow-y-auto"
            ...
            >
                <div className="px-6 py-4 border-b border-black/[0.08] flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm font-display text-black/85 mt-1">
                            {talent.name}
                        </p>
                    </div>
                    <button
                        onClick={onClose}
                        className="text-black/50 hover:text-black/80 text-xs transition-colors duration-150"
                    >
                        Close
                    </button>
                </div>
                <div className="p-6 space-y-3">
                    <p className="text-[11px] text-black/45 leading-relaxed mb-2">
                        Override the link-level visibility for{" "}
                        <strong className="text-black/85">{talent.name}</strong> only. Leave a row on
                ...
                <div className="px-6 py-4 border-t border-black/[0.08] flex items-center justify-between gap-3">
                    <button
                        onClick={onClear}
                        className="text-xs text-black/60 hover:text-black/80 transition-colors duration-150"
                    ...
                    <button
                        ...
                        className="bg-black text-white px-5 py-2 text-sm rounded-lg hover:bg-black/90 transition-colors duration-150"
                    >
                        Save overrides
                    </button>
                </div>
