...
"""
from . import crm, casting_pipeline, whatsapp_campaign_agent, talentgram_fetcher, management_agent

_MODULES = [crm, casting_pipeline, whatsapp_campaign_agent, talentgram_fetcher, management_agent]
